...
def p_parameters_dontforgettoremove(p):
    """
    Parameters : DONTFORGETTOREMOVE
    """
...
def p_pairlist_dontforgettoremove(p):
    """
    PairList : DONTFORGETTOREMOVE
    """
...
def p_arrayindexes_dontforgettoremove(p):
    """
    ArrayIndexes : DONTFORGETTOREMOVE
    """
